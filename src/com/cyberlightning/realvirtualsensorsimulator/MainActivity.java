...
@SuppressLint("HandlerLeak") public class MainActivity extends Activity implements Observer,IMainActivity {
    ...
    public void onSettingsItemClicked() {
        ...
        if(this.mainViewFragment.isPause && this.markerViewFragment != null && !this.markerViewFragment.isInLayout()) this.showToast(getString(R.string.toast_sensorlistener_stopped));
    }
